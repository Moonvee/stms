	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				...
				<ul class="cl">
					<li>
						<?php echo session('tec_info.tid'); ?>&nbsp;&nbsp;
					</li>
					<li class="dropDown dropDown_hover">
						<a href="#" class="dropDown_A">
							<?php echo session('tec_info.name'); ?>&nbsp;
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe60d;</i> <?php echo lang('tecinfo'); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('teacher/info'); ?>" href="javascript:;" data-title="<?php echo lang('stu-info'); ?>"><?php echo lang('stu-info'); ?></a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe60d;</i> <?php echo lang('tectest'); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('teacher/testup'); ?>" href="javascript:;" data-title="<?php echo lang('test-up'); ?>"><?php echo lang('test-up'); ?></a></li>
                </ul>
            </dd>
        </dl>
      </div>
