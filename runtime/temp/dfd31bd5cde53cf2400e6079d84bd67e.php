	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				...
				<ul class="cl">
					<li>
						<?php echo session('col_info.xid'); ?>&nbsp;&nbsp;
					</li>
					<li class="dropDown dropDown_hover">
						<a href="#" class="dropDown_A">
							<?php echo session('col_info.name'); ?>&nbsp;
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe60d;</i> <?php echo lang('colinfo'); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('college/info'); ?>" href="javascript:;" data-title="<?php echo lang('col-info'); ?>"><?php echo lang('col-info'); ?></a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe60d;</i> <?php echo lang('coltec'); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('college/tec'); ?>" href="javascript:;" data-title="<?php echo lang('colteclist'); ?>"><?php echo lang('colteclist'); ?></a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe60d;</i> <?php echo lang('colstu'); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('college/stu'); ?>" href="javascript:;" data-title="<?php echo lang('colstulist'); ?>"><?php echo lang('colstulist'); ?></a></li>
                </ul>
            </dd>
        </dl>
      </div>
