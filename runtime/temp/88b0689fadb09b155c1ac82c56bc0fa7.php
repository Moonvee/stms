...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-bg mt-20">
		...
		<tbody>
			<tr>
				<th width="30%">账号</th>
				<td><span id="lbServerName"><?php echo session('col_info.xid'); ?></span></td>
			</tr>
			<tr>
				<td>姓名</td>
				<td><?php echo session('col_info.name'); ?></td>
			</tr>
			<tr>
				<td>校区</td>
				<td><?php echo session('col_info.xiaoqu'); ?></td>
			</tr>
			<tr>
				<td>学院</td>
				<td><?php echo session('col_info.xueyuan'); ?></td>
			</tr>
			<tr>
				<td>上次登录时间</td>
				<td><?php echo date("Y-m-d H:i:s",\think\Session::get('col_info.login_time')); ?></td>
			</tr>
		</tbody>
	</table>
</div>
