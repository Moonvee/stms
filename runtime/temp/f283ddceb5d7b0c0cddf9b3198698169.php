...
<article class="cl pd-20">
	...
	<form action="" method="post" class="form form-horizontal" id="form-class-edit">
		...
		<!--将当前记录的id做为隐藏域发送到服务器-->
		<input type="hidden" value="<?php echo session('user_id'); ?>" name="id">
...
<script>
	$(function(){
        ...
        $("#submit").on("click", function(event){
            $.ajax({
							type: "POST",
							url: "<?php echo url('student/doPwEdit'); ?>",
