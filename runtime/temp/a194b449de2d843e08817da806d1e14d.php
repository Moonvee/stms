...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>预约状态：</label>
            <div class="formControls col-xs-6 col-sm-6 skin-minimal">
                <div class="radio-box">
                    <input type="radio" name="auth" id="radio-0" value="1">
                    <label for="radio-0">开启</label>
                </div>
                <div class="radio-box">
                    <input type="radio" name="auth" id="radio-1" value="0">
