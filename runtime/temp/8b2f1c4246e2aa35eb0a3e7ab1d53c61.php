<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/Users/moonvee/Project/website/Stms/public/../application/college/view/user/login.html";i:1541406565;}*/ ?>
<!DOCTYPE>
				...
				<form id="form" method="post" class="form form-horizontal ">
					<div class="row cl">
						...
						<div class="formControls col-xs-6 col-ms-6">
							<input name="xid" type="text" placeholder="请填写帐号" class="input-text long size-L" datatype="*" nullmsg="请填写帐号" onkeydown="KeyDown();">
						</div>
					</div>
					<div class="row cl">
