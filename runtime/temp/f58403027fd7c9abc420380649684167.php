          ...
          <td><?php echo $vo['tiaosheng']; ?> 次/分</td>
			...
			<?php endforeach; endif; else: echo "" ;endif; ?>
				<tr class="bg">
					...
					<th>您的BMI为<?php echo $bmi['bmi']; ?>，属于<?php echo $bmi['bmic']; ?>，建议<?php echo $bmi['bmia']; ?>。</th>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tr>
				<tr>
					<td colspan="2">
