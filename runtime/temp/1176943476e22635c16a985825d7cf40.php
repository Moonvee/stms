<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/Users/moonvee/Project/website/Stms/public/../application/index/view/user/login.html";i:1538444432;}*/ ?>
<!DOCTYPE>
  ...
  <div class="dl">
		...
		<div class="log">
			<ul class="left">
				 ...
				 <li class="mt-5">
					 <a class="btn btn-primary radius size-L ml-10 mt-10" href="<?php echo url('teacher/user/login'); ?>" target="_blank">教师登录</a>
					 <a class="btn btn-primary radius size-L ml-20 mt-10" href="<?php echo url('college/user/login'); ?>" target="_blank">学院登录</a>
				 </li>
			</ul>
			  <ul class="right">
					<form id="form" method="post" class="form form-horizontal ">
	            <div class="row cl">
	                <label class="form-label col-xs-3 col-ms-3" style="line-height: 36px;font-size: 20px;color:#008384;">学号</label>
	                <div class="formControls col-xs-6 col-ms-6">
	                    <input name="sid" type="text" placeholder="请填写学号" class="input-text long size-L" datatype="*" nullmsg="请填写学号" onkeydown="KeyDown();">
	                </div>
	            </div>
	            <div class="row cl">
	            ...
	            <div class="row cl">
	                <div class="formControls col-xs-3 col-ms-3 col-xs-offset-3">
	                    <input name="btn" type="button" id="login" class="btn btn-success radius size-L mr-20" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
									...
									<div class="formControls  col-xs-offset-6">
										<input name="" type="button" id="reg" class="btn btn-success radius size-L ml-20" value="&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;">
								</div>
							</div>
    ...
    $("#login").on('click',function(event){
      $.ajax({
		...
		$("#reg").on('click',function(){
			window.location.href="<?php echo url('user/reg'); ?>";
		})
