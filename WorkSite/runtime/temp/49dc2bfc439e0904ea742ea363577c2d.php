<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\WorkSite\public/../application/admin\view\info\edit.html";i:1521193544;s:63:"D:\WorkSite\public/../application/admin\view\template\base.html";i:1488957233;s:74:"D:\WorkSite\public/../application/admin\view\template\javascript_vars.html";i:1488957233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" style="border:0px solid ;" placeholder="学号" name="account" value="<?php echo isset($vo['account']) ? $vo['account'] :  ''; ?>" readonly>
            </div>
...
<script type="text/javascript" src="__LIB__/jQueryCityHui/jquery.provincesCity.js"></script>
<script type="text/javascript" src="__LIB__/jQueryCityHui/provincesData.js"></script>
<script>
    $(function () {
